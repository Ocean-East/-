...
parser.add_argument('--train-file', default='translation2019zh_txt/processed_train.txt')
parser.add_argument('--dev-file', default='translation2019zh_txt/processed_valid.txt')
